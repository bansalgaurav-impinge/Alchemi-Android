...
import com.app.alchemi.BaseDotsIndicator.Type.DEFAULT
...
//          val nextDotBackground = nextDot.background as DotsGradientDrawable
          ...
          if (selectedDotColor != dotsColor) {
            ...
            //nextDotBackground.setStroke(dotsStrokeWidth, dotsStrokeColor)
            nextDotBackground.setStroke(dotsStrokeWidth, ContextCompat.getColor(context,R.color.colorYellow))
  ...
  override fun refreshDotColor(index: Int) {
    ...
    //  background.setColor(dotsColor)
      ...
      background.setStroke(dotsStrokeWidth, ContextCompat.getColor(context,R.color.colorYellow))

     // background.setStroke(10, android.R.color.holo_red_dark)
    }
