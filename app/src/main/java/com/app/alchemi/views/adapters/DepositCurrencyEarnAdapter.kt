...
import com.app.alchemi.views.fragments.dashboardFeatures.EarnFragment
import kotlinx.android.synthetic.main.buy_crypto_adapter.view.*


internal class DepositCurrencyEarnAdapter(
    topGainersList: List<TopGainer>,
    earnFragment: EarnFragment
) : RecyclerView.Adapter<DepositCurrencyEarnAdapter.ViewHolder>() {
    val topGainersList: List<TopGainer> = topGainersList
    private var mContext: Context? = null
    var onItemClickListener: OnItemClickListener =earnFragment
